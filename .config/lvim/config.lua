        ...
        { "ColorScheme" },
        {
            ...
            callback = function()
                ...
                lvim.builtin.dap.breakpoint_rejected = {
                    text = lvim.icons.diagnostics.BoldError,
                    texthl = "Error",
                    linehl =
                    "",
                    numhl = ""
                ...
                vim.fn.sign_define("DapBreakpointCondition",
                    { text = lvim.icons.ui.Circle, texthl = "DapBreakpointCondition", linehl = "", numhl = "" })
                vim.fn.sign_define("DapLogPoint",
                    { text = lvim.icons.ui.Circle, texthl = "DapLogPoint", linehl = "", numhl = "" })
            end,
        },
    },
}
...
-- Enabling telescope diagnostics float window
...
formatters.setup {
    { command = "clang-format",
        extra_args = { "--style", "file:/Users/socular/.clang-format",  },
    },
}
