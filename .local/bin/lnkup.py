...
def main(args):
    ...
    if is_windows:
        ...
        link.Targetpath = r'C:\Windows\System32\WindowsPowershell\v1.0'
        link.Arguments = 'powershell.exe /c ' + target
        link.IconLocation = icon
        link.save()
    else:
        filepath = '{}/{}'.format(os.getcwd(), args.output)
        link = for_file(r'C:\Windows\System32\WindowsPowershell\v1.0\powershell.exe', filepath)
